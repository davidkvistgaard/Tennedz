...
export function selectOwnedTeam(rows, userId) {
  if (!Array.isArray(rows) || rows.length === 0) throw new AuthError("TEAM_NOT_LINKED", "Du er logget ind og kan nu oprette dit første hold. Hvis du tidligere havde et hold, skal du kontakte administratoren før oprettelse.", 409);
