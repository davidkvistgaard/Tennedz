...
const extras=[];
function feature(id,name,type,parentId,geometry,representations,properties={},extra={}){extras.push({id,name,type,parentId,status:'concept',gridCells:[],geometry,minZoom:1,maxZoom:4,description:'Prototype geometry; placement and shape are design proposals.',relations:[],properties:{geometryStatus:'prototype',...properties},representations,...extra});}
islands.forEach((g,i)=>feature(`ATLAS-ISLAND-00${i+1}`,`Southeastern island ${i+1}`,'island_nation','REG-012',g,[rep(g,'land')],{workingLabel:true}));
...
place('CITY-001',city,[rep(point(270,286),'capital',1,2,true),rep(city,'city-area',2,4)],{focusBounds:[260,275,283,292.25],gridCells:['I10','J10'],description:'Capital beside a south-facing estuary. The city footprint and districts use prototype geometry.'});
feature('AUR-GEO-001','The estuary','river_system','CITY-001',poly([[271,272],[271.3,278],[272.1,282],[273.1,286],[275.5,290],[278,296],[274,298],[273,291],[271.7,286],[271,282],[270.5,278],[270.6,272]]),[rep(poly([[271,272],[271.3,278],[272.1,282],[273.1,286],[275.5,290],[278,296],[274,298],[273,291],[271.7,286],[271,282],[270.5,278],[270.6,272]]),'water',2,4)]);
feature('AUR-GEO-002','Aurelia Bay','lake','CITY-001',oval(278,299,8,9),[rep(oval(278,299,8,9),'water',2,4)],{waterKind:'bay'});
const ds=[
...
feature('AUR-SITE-001','Cathedral building','landmark','AUR-LMK-001',poly([[267.71,282.675],[267.775,282.675],[267.775,282.65],[267.809,282.65],[267.809,282.675],[267.885,282.675],[267.898,282.686],[267.898,282.71],[267.885,282.72],[267.809,282.72],[267.809,282.742],[267.775,282.742],[267.775,282.72],[267.71,282.72]]),[rep(poly([[267.71,282.675],[267.775,282.675],[267.775,282.65],[267.809,282.65],[267.809,282.675],[267.885,282.675],[267.898,282.686],[267.898,282.71],[267.885,282.72],[267.809,282.72],[267.809,282.742],[267.775,282.742],[267.775,282.72],[267.71,282.72]]),'building',4,4,true)],{lengthM:188,widthM:92});
feature('AUR-SITE-002','Cathedral square','landmark','AUR-LMK-001',box(267.46,282.7,.25,.18),[rep(box(267.46,282.7,.25,.18),'plaza',4,4,true)]);
feature('AUR-SITE-003','Cathedral gardens','landmark','AUR-LMK-001',box(267.92,282.59,.19,.38),[rep(box(267.92,282.59,.19,.38),'park',4,4,true)]);
feature('AUR-SITE-004','Cultural building · proposal','landmark','AUR-LMK-001',box(267.75,282.91,.13,.065),[rep(box(267.75,282.91,.13,.065),'building',4,4,true)]);
feature('AUR-SITE-005','Associated building · proposal','landmark','AUR-LMK-001',box(267.73,282.57,.115,.05),[rep(box(267.73,282.57,.115,.05),'building',4,4,true)]);
...
roads.forEach((coords,i)=>feature(`AUR-INF-00${i+1}`,`Main connection ${i+1}`,'fixed_connection','CITY-001',line(coords),[rep(line(coords),'road',3,4)],{workingLabel:true}));
...
feature('AUR-SITE-006','Garden pavilion · proposal','landmark','AUR-SITE-003',box(268.01,282.73,.025,.025),[rep(box(268.01,282.73,.025,.025),'building',4,4,true)],{extensionExample:true});
...
feature('AUR-SITE-007','Cathedral roof ridge','landmark','AUR-SITE-001',line([[267.715,282.697],[267.89,282.697]]),[rep(line([[267.715,282.697],[267.89,282.697]]),'roof',4,4)]);
feature('AUR-SITE-008','Cathedral transept','landmark','AUR-SITE-001',line([[267.792,282.652],[267.792,282.74]]),[rep(line([[267.792,282.652],[267.792,282.74]]),'roof',4,4)]);
