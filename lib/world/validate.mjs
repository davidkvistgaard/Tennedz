...
export function validateWorld(world) {
  ...
  for (const o of ids.values()) {
    ...
    if (o.type === 'grid_cell') {
      ...
      if (code === 'P') {
        if (o.properties.classificationStatus !== 'unresolved' || o.properties.regionId !== null) fail(o.id,'undefined P must remain unresolved');
      } else if (o.properties?.classificationStatus !== 'defined') fail(o.id,'classification must be defined');
