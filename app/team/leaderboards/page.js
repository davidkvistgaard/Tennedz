...
export default function LeaderboardsPage(){
  ...
  return <TeamShell title="Ranglister"><h1>Optjente løbspoint</h1>
    <label>Løbskategori <select value={gender} onChange={e=>setGender(e.target.value)}><option value="M">Mænd</option><option value="F">Kvinder</option></select></label>
    <p>Holdrating er summen af de 16 bedst ratede ryttere i den valgte kategori. Form og træthed ændrer ikke pointene.</p>
    <p role="status">{error || (!data?"Henter ranglister…":"")}</p>
